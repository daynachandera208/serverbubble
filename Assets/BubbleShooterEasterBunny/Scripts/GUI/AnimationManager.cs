...
public class AnimationManager : MonoBehaviour
{
    ...
    {
        if( name == "MenuComplete" || name == "MenuLevelComplete")
        {
    ...
    public void Play()
    {
       ...
       /* else if( gameObject.name == "PlayMain" )
        ...
        else if (gameObject.name == "PlayOffline")
        {
            if (GameObject.Find("MenuMessage") != null && GameObject.Find("MenuMessage").GetComponent<TextMeshProUGUI>().text != "Waiting For Opponent...!")
                ColyseusClient.Instance.isoffline = true;
            Application.LoadLevel( "map" );
        }
    }
    ...
    public void Quit()
    {
        if (Application.loadedLevelName == "game")
        {
            if (ColyseusClient.Instance.isoffline)
                Application.LoadLevel("map");//original code
            else
            {
                ColyseusClient.Instance.isGameQuit = true;
                ColyseusClient.Instance.SendMessage("GameQuit");
